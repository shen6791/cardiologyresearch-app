  ...
  return (
    <div>
      ...
      <div className="max-w-5xl mx-auto px-6 pb-24 grid md:grid-cols-[1fr_1.4fr] gap-8">
        <Reveal>
          <div className="card-lift border border-[var(--border)] rounded-lg p-8 h-fit">
            <div className="font-display font-semibold text-lg">{s.doctor_name}</div>
            <div className="text-sm text-[var(--muted)] mt-1 mb-6">Ceylon Cardiology Research</div>
            <a href={`mailto:${s.contact_email}`} className="btn-lift inline-block px-6 py-3 rounded-md bg-[var(--accent)] text-white font-medium text-sm">
