  ...
  return (
    <div>
      ...
      <div className="max-w-5xl mx-auto px-6 pb-24 flex flex-col gap-4">
        {items.map((f) => (
          <div key={f.id} className="border border-[#e6e3db] rounded-lg p-7 flex items-center gap-6 flex-wrap">
            ...
            {f.pdf_url && <a href={f.pdf_url} target="_blank" rel="noopener" className="px-5 py-2.5 rounded-md border border-[#d8d4c8] text-sm font-medium hover:border-[#0f5d52]">Learn More</a>}
          </div>
        ))}
