  ...
  return (
    <div>
      ...
      <div className="max-w-5xl mx-auto px-6 pb-24">
        {videos.length === 0 ? (
          <div className="border border-dashed border-[var(--border-strong)] rounded-lg p-12 text-center text-sm text-[var(--muted)]">No videos published yet. Check back soon.</div>
        ) : (
          <div className="grid md:grid-cols-2 gap-5">
            {videos.map((v, i) => (
              <Reveal key={v.id} delay={i * 60}>
                <div className="card-lift border border-[var(--border)] rounded-lg overflow-hidden">
